        ...
        $(document).ready(function () {
            ...
            $('.btn-create-order').click(function () {
                ...
                var req = {
                    ...
                    coupon_code: $('input[name=coupon_code]').val(), // 9.4 添加:从优惠码输入框中获取优惠码
                };
                ...
                axios.post('{{ route('orders.store') }}', req)
                    .then(function (response) {
                        //swal('订单提交成功', '', 'success');
                        swal('订单提交成功', '', 'success')  //6.7. 用户订单详情页 修改
                            .then(() => {
                        ...
                        } else if(error.response.status === 403){ //9.5. 优化优惠券模块 添加
